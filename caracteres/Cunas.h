...
public:
  ...
  String textos[3][10] = {
      {"El diseno especulativo ensaya futuros que cuestionan lo existente",
       ...
       "La cultura hacker plantea que la tecnologia es un lugar en constante disputa",
       ...
       "Que particularidades tienen las practicas que se gestan en America Latina?"},
      {
          ...
          "Como podemos hacernos cargo de lo que aparece como marginalidad del diseno?",
      ...
      {"Que tipo de educacion en arte, arquitectura y diseno se necesita en Chile?",
       ...
       "El diseno se presenta al servicio del humano, pero su ambicion es redisenarlo",
       ...
       "Como podemos desde el diseno proponer nuevas maneras de entender la tecnologia?",
