direcciones = {
    ...
    "192.168.1.12": {
        ...
        "tipoPantalla": 1,
        "numero": 2,
        "comandoPrefijo": "vlc --fullscreen --no-video-deco --qt-minimal-view --no-sub-autodetect-file --no-video-title-show --play-and-exit './../../respuestas/",
        "comandoSufijo": ".mp4'",
        "comandoGenerativa": "vlc --fullscreen --no-video-deco --qt-minimal-view --no-sub-autodetect-file --no-video-title-show --play-and-exit '",
        "comandoSufijoGenerativa": ".mov'",
    },
    "192.168.1.13": {
        ...
        "tipoPantalla": 2,
        "numero": 1,
        "comandoPrefijo": "vlc --fullscreen --no-video-deco --qt-minimal-view --no-sub-autodetect-file --no-video-title-show --play-and-exit './../../preguntas/",
        "comandoSufijo": ".mp4'",
        "comandoGenerativa": "vlc --fullscreen --no-video-deco --qt-minimal-view --no-sub-autodetect-file --no-video-title-show --play-and-exit '",
        "comandoSufijoGenerativa": ".mov'",
    },
